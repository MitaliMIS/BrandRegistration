...
.textarea1 {
   ...
   <div>
			...
			<h:inputHidden value="#{replyForObjections_21_22Action.hidden}" />
			<div class="row " align="center">
				<div align="center">
					<h1
						style="COLOR: #000000; TEXT-DECORATION: underline; font-family: Monotype Corsiva; font-weight: 900;">
						<b> <h:outputText value="Reply To Given Objections For Brand Registration 2021-22" /></b>
			...
			<div class="row" style="margin-top: 5px;" align="center">
						<rich:dataTable align="center" id="table1" rows="10" width="100%"
							var="list"
							value="#{replyForObjections_21_22Action.objectionlist}"
							...
							<rich:column>
								...
								<h:commandButton class="btn btn-primary"
									actionListener="#{replyForObjections_21_22Action.view}" value="view" disabled="#{list.disableFlg }"/>
								</center>
							</rich:column>
			 ...
			 <h:panelGroup rendered="#{replyForObjections_21_22Action.viewPanelFlg}">
			...
			<div align="center" class="row">
					<div align="center" class="col-md-2">
						...
						<div align="center" class="col-md-4">
							...
							<h:inputText  styleClass="form-control" disabled="true" 
								value="#{replyForObjections_21_22Action.title}" />
						</div>
						...
						<div>
							...
							<rich:calendar  value="#{replyForObjections_21_22Action.obj_date }" disabled="true"/>
					...
					<div align="center" class="col-md-2">
						...
						<div align="center" class="col-md-4">
							...
							<h:outputText   
								value="#{replyForObjections_21_22Action.description}" />
						</div>
					...
					action="/BrandRegistration/ReplyForObjections_21_22?appID=#{replyForObjections_21_22Action.allId} "
			...
			<h:form style="FONT-SIZE: xx-small;">
				<div class="row"
					...
					<div class="row" align="center">
						...
						<div class="col-md-6 col-sm-1">
							<h:commandButton value="Upload PDF File"
								...
								action="#{replyForObjections_21_22Action.save1}" />
								<h:outputLink target="_blank"
								rendered="#{replyForObjections_21_22Action.pdfDone}"
								value="/doc/ExciseUp/LabelRegistration_21_22/objection/#{replyForObjections_21_22Action.uploadedPdf}">
					...
					<div class="col-md-12">
						...
						<div class="col-md-6 col-sm-8">
							...
							<div class="row">
								<h:inputTextarea
									value="#{replyForObjections_21_22Action.fillComment}"
				...
				<div class="row" align="center">
					...
					<h:commandButton value="Submit" styleClass="btn btn-success"
						action="#{replyForObjections_21_22Action.save}" />
					<h:commandButton value="Reset" styleClass="btn btn-warning"
						action="#{replyForObjections_21_22Action.reset}" />
				...
				<h:form>
					...
					<h:commandButton value="Back" styleClass="btn btn-danger"
						action="#{replyForObjections_21_22Action.back}" /></div>
