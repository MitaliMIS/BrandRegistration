	...
	<f:view>
		<h:form>
			...
			<div align="center">
				...
				<h:outputText value="Make Payment 2021-22"
			...
			<div class="col-md-12 wow shake" align="center">
				...
				<h:inputHidden value="#{brandChallan_21_22Action.hidden}"></h:inputHidden>
			...
			<div class="row col-md-12">
				...
				<div class="  col-md-6" align="right">
					<h:commandButton action="#{brandChallan_21_22Action.moveToLabelDash}"
						value="Back To DashBoard" styleClass="btn   btn-danger"></h:commandButton>
				</div>
			</div>
			

			<h:panelGroup rendered="#{brandChallan_21_22Action.radioType1 eq 'A'}">
				<div class="row col-md-12" align="center">
					<h:selectOneRadio value="#{brandChallan_21_22Action.radioType}"
						valueChangeListener="#{brandChallan_21_22Action.radioVal}"
				...
				<rich:dataTable width="100%" var="list"
					value="#{brandChallan_21_22Action.brandChallan}">
					...
					<rich:column align="center"
						rendered="#{brandChallan_21_22Action.radioType ne 'D'}">
						<f:facet name="header">
				...
				<h:panelGroup
						...
						<div class="col-md-12">
							...
							<div class="col-md-6" align="center">
								...
								<rich:dataTable columnClasses="columnClass1"
									...
									value="#{brandChallan_21_22Action.addRowBrand}" var="list">
									<rich:column>
										<f:facet name="header">
									...
									<rich:column>
										<f:facet name="header">
											<h:commandButton class="imag"
												action="#{brandChallan_21_22Action.addRowMethodBrand}"
												image="/img/add.png"
										...
										<center>
											<h:commandButton class="imag"
												actionListener="#{brandChallan_21_22Action.deleteRowMethodBrand}"
							...
							<div class="col-md-6" align="center">
								...
								<rich:dataTable columnClasses="columnClass1"
									...
									value="#{brandChallan_21_22Action.addRowlabel}" var="list">
									<rich:column>
										<f:facet name="header">
											<h:outputText value="Sr.No">
											</h:outputText>
									...
									<rich:column>
										<f:facet name="header">
											<h:commandButton class="imag"
												action="#{brandChallan_21_22Action.addRowMethodlabel}"
												image="/img/add.png" />
										</f:facet>
										<center>
											<h:commandButton class="imag"
												actionListener="#{brandChallan_21_22Action.deleteRowMethodlabel}"
												style="background: transparent;height:30px "
												image="/img/del.png" />
										</center>
									</rich:column>
					...
					<div align="center">
						<h:commandButton value="Finalize" rendered="false"
							styleClass="btn btn-sm  btn-success"
							action="#{brandChallan_21_22Action.finalizeData}">
							</h:commandButton>
