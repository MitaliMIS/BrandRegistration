									...
									<div class="row" align="center"
										...
										<div class="col-md-12" align="center">
											<h:selectOneRadio style="width:35%" disabled="true"
												...
												<f:selectItem itemValue="ImprtUnit"
									...
									<div class="container">
										...
										<div class="col-md-2" align="right">
										 ...
										 <div class="col-md-2" align="left">
											<h:selectOneRadio  disabled="false"
												value="#{brand_Registration_2019_2020Action.radioType2}"
												onchange="this.form.submit();" >
											   
											    <f:selectItem itemValue="C" itemLabel="Country" />
											     
												<f:selectItem itemValue="S" itemLabel="State" />
											   ...
											   <div class="col-md-3" align="left">
															...
															<div class="col-md-3" align="left">
																...
																<h:inputText styleClass="inputtext"
																	...
																	id="bb"
																	disabled="#{brand_Registration_2019_2020Action.radioType eq 'BWFL' or brand_Registration_2019_2020Action.radioType eq 'ImprtUnit'}">
														...
														<div class="col-md-12">
															...
															<div class="col-md-2" align="right"
																...
																<h:outputLabel value="License Type :"
																	style="FONT-WEIGHT: bold;"
																	rendered="#{brand_Registration_2019_2020Action.radioType ne 'ImprtUnit'}"></h:outputLabel>

																<h:outputLabel value="Unit Type :"
																	style="FONT-WEIGHT: bold;"
																	rendered="#{brand_Registration_2019_2020Action.radioType eq 'ImprtUnit'}"></h:outputLabel>
															</div>
															...
															<div class="col-md-3" align="left">
																...
																<h:selectOneMenu styleClass="dropdown-menu1"
																	value="#{brand_Registration_2019_2020Action.type_Bwfl_Shop}"
																	id="ImprtUnit"
																	rendered="#{brand_Registration_2019_2020Action.radioType eq 'ImprtUnit'}"
																	onchange="this.form.submit();">
																	<f:selectItem itemLabel="----Select----" itemValue="NA" />
																	<f:selectItem itemLabel="Importing Unit" itemValue="IU" />
																	<f:selectItem itemLabel="Distillery For CSD"
																		itemValue="DCSD" />
																	<f:selectItem itemLabel="Brewery For CSD"
																		itemValue="BCSD" />
																	<f:selectItem itemLabel="Bottling Unit For CSD"
																		itemValue="BUCSD" />
																	<f:selectItem itemLabel="Winery For CSD"
																		itemValue="WCSD" />
																</h:selectOneMenu>
															</div>
															<div class="col-md-1"></div>
...
<div class="col-md-12">
															...
															<div class="col-md-2" align="right">
																<h:outputText value="Whether this brand is already registered for civil:"
																	style="FONT-WEIGHT: bold;"></h:outputText>
															</div>
															<div class="col-md-3" align="left">
																<h:selectOneMenu styleClass="dropdown-menu1"
														...
														<div class="col-md-12">
															...
															<div class="col-md-3" align="left">
																<h:selectOneMenu styleClass="dropdown-menu1"
																	...
																	id="FL"
																	rendered="#{brand_Registration_2019_2020Action.liquorTypeId eq 'FL' or brand_Registration_2019_2020Action.liquorTypeId eq 'IMPORTED FL'}"
																	onchange="this.form.submit();">
																	<f:selectItem itemLabel="----Select----" itemValue="" />
																	<f:selectItem itemLabel="Whisky" itemValue="Whisky" />
																	<f:selectItem itemLabel="Rum" itemValue="Rum" />
																	<f:selectItem itemLabel="Scotch" itemValue="Scotch" />
																	<f:selectItem itemLabel="Takila" itemValue="Takila" />
																	<f:selectItem itemLabel="Vodka" itemValue="Vodka" />
																	<f:selectItem itemLabel="Gin" itemValue="Gin" />
																...
																<h:selectOneMenu styleClass="dropdown-menu1"
																	...
																	<f:selectItem itemLabel="Masala" itemValue="Masala" />
														...
														<rich:dataTable columnClasses="columnClass1"
															...
															<rich:column>
																...
																<h:selectOneMenu styleClass="dropdown-menu" id="menu"
																	...
																	<f:selectItem itemValue="CAN" itemLabel="CAN" />
																	<f:selectItem itemValue="Glass Bottle" itemLabel="Glass Bottle" />
																	<f:selectItem itemValue="Tetra Pack" itemLabel="Tetra Pack" />
																	<f:selectItem itemValue="Pet Bottle" itemLabel="Pet Bottle" />
																	<f:selectItem itemValue="Sachet" itemLabel="Sachet" />
																	<f:selectItem itemValue="Keg" itemLabel="Keg" />
																</h:selectOneMenu>
