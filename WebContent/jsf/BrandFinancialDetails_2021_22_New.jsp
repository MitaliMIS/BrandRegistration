			...
			<div  >
				...
				<div class="row">
					<div align="center">
						<div class="col-md-12">
							<h:selectOneRadio
								disabled="#{brandFinancialDetails_2021_22_NewAction.edit_flag1 eq 'T' }"
								value="#{brandFinancialDetails_2021_22_NewAction.unitType}"
								valueChangeListener="#{brandFinancialDetails_2021_22_NewAction.unitChange}"
				...
				<div class="row" align="center">
					...
					<div class="col-md-4" align="left">
						<h:selectOneMenu
							disabled="#{brandFinancialDetails_2021_22_NewAction.edit_flag1 eq 'T' }"
							value="#{brandFinancialDetails_2021_22_NewAction.unitId}"
							styleClass="form-control" onchange="this.form.submit();"
							valueChangeListener="#{brandFinancialDetails_2021_22_NewAction.onChangeDropdown }">
							<f:selectItems
								value="#{brandFinancialDetails_2021_22_NewAction.unitName}" />
						</h:selectOneMenu>
					</div>
				...
				<div class="col-md-6" align="left">
					<h:selectOneRadio
						disabled="#{brandFinancialDetails_2021_22_NewAction.edit_flag1 eq 'T' }"
						rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'D' or brandFinancialDetails_2021_22_NewAction.unitType eq 'B'}"
						value="#{brandFinancialDetails_2021_22_NewAction.civilcsd}"
						onchange="this.form.submit();"
						valueChangeListener="#{brandFinancialDetails_2021_22_NewAction.forcivilcsd}">
						<f:selectItem itemValue="Civil" itemLabel="Civil" />
						<f:selectItem itemValue="CSD" itemLabel="CSD" />

					</h:selectOneRadio>
					<h:selectOneRadio
						rendered="#{brandFinancialDetails_2021_22_NewAction.unitType ne 'D' and brandFinancialDetails_2021_22_NewAction.unitType ne 'B'}"
						disabled="true"
						value="#{brandFinancialDetails_2021_22_NewAction.civilcsd}">
						<f:selectItem itemValue="Civil" itemLabel="Civil" />
						<f:selectItem itemValue="CSD" itemLabel="CSD" />
				...
				<div class="col-md-5" align="right">
					<h:outputLabel value="Domain" 	 rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'D' or brandFinancialDetails_2021_22_NewAction.unitType eq 'B'}"></h:outputLabel>
				</div>
				<div class="col-md-6" align="left">
					<h:selectOneRadio
						disabled="#{brandFinancialDetails_2021_22_NewAction.edit_flag1 eq 'T' }"
						 rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'D' or brandFinancialDetails_2021_22_NewAction.unitType eq 'B'}"
						value="#{brandFinancialDetails_2021_22_NewAction.domain}"
						onchange="this.form.submit();"
						valueChangeListener="#{brandFinancialDetails_2021_22_NewAction.valuechangedomain}">
					...
					<h:panelGroup>
						<div class="col-md-12">
							...
							<rich:dataTable columnClasses="columnClass1"
								...
								value="#{brandFinancialDetails_2021_22_NewAction.displayBrandDetails}"
								var="list">
								<rich:column>
									<f:facet name="header">
								...
								<rich:column>
									...
									<h:selectOneMenu value="#{list.liq_cat}"
										...
										valueChangeListener="#{brandFinancialDetails_2021_22_NewAction.catChange}">
								...
								<rich:column width="7%"
									rendered="#{ (brandFinancialDetails_2021_22_NewAction.unitType eq 'D'  or brandFinancialDetails_2021_22_NewAction.unitType eq 'B'  or brandFinancialDetails_2021_22_NewAction.unitType eq 'BWFL'   ) }">
									<f:facet name="header">
										<h:outputText value="EDP" />
									</f:facet>
									<h:inputText value="#{list.edp }" class="form-control" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.duty }" class="form-control" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.addnl_duty }" class="form-control" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									rendered="#{ (brandFinancialDetails_2021_22_NewAction.unitType eq 'D' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'Civil' or brandFinancialDetails_2021_22_NewAction.unitType eq 'B' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'Civil' or brandFinancialDetails_2021_22_NewAction.unitType eq 'BWFL' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'Civil' ) }">
									<f:facet name="header">
										<h:outputText styleClass="preformatted"
											value="Wholesale Margin" />
									</f:facet>
									<h:inputText value="#{list.wholesalemargin }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.retailmargin }" class="form-control" style="COLOR: #0000a0;"  disabled="#{!list.dis_flg }" >
									<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									rendered="#{ (brandFinancialDetails_2021_22_NewAction.unitType eq 'D' and brandFinancialDetails_2021_22_NewAction.domain eq 'UP' or brandFinancialDetails_2021_22_NewAction.unitType eq 'B' and brandFinancialDetails_2021_22_NewAction.domain eq 'UP' or brandFinancialDetails_2021_22_NewAction.unitType eq 'BWFL' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'Civil' ) }">
									<f:facet name="header">
										<h:outputText styleClass="preformatted"
											value="Spl. Addl. CESS" />
									</f:facet>
									<h:inputText value="#{list.spl_addl_cess }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }"
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
								...
								<rich:column width="7%"
									rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'IUCIVIL' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'Civil' }">
									<f:facet name="header">
										<h:outputText value="CIF" />
									</f:facet>
									<h:inputText value="#{list.cif }" class="form-control" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
									<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.cb_handling_charage }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.margin }" class="form-control"  style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
									<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.custom_duty }" class="form-control" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
									<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
								</rich:column>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.permit_fee_on750 }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.margin_wholesale }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.margin_of_retailer }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
								</rich:column>
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.spcl_addl_cosid_fee }" style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" 
										class="form-control" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
								...
								<rich:column width="7%"
									rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'IUCSD' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'CSD'}">
									<f:facet name="header">
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.permit_fee }" class="form-control" style="COLOR: #0000a0;"  disabled="#{!list.dis_flg }" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
								...
								<rich:column width="7%"
									rendered="#{brandFinancialDetails_2021_22_NewAction.unitType eq 'IUCSDOUP' and brandFinancialDetails_2021_22_NewAction.civilcsd eq 'CSD' }">
									<f:facet name="header">
								...
								<rich:column width="7%"
									...
									<h:inputText value="#{list.csd_cal_duty }" class="form-control"  style="COLOR: #0000a0;" disabled="#{!list.dis_flg }" >
										<f:convertNumber maxFractionDigits="2" pattern="#############0.00" />
									</h:inputText>
									<a4j:support event="onblur" reRender="maxwholemrp">
									</a4j:support>
...
<rich:column width="7%"
								...
								<rich:column>
									<f:facet name="header">
										<h:commandButton class="imag"
											...
											action="#{brandFinancialDetails_2021_22_NewAction.addRow_dis}"
											image="/img/add.png" />
									</f:facet>
									<h:commandButton class="imag"
										 
										actionListener="#{brandFinancialDetails_2021_22_NewAction.deleteRow_dis}"
				...
				<div class="col-md-12 btn " style="background-color: beige;">
					...
					<div class="col-md-3" align="left">
						<rich:fileUpload clearControlLabel="clear" stopControlLabel="Stop"
							...
							fileUploadListener="#{brandFinancialDetails_2021_22_NewAction.upload}">
					...
					<div class="col-md-3 img-responsive" align="left">
						...
						<a4j:outputPanel id="renpdftrue2">
							<h:outputLink
								rendered="#{brandFinancialDetails_2021_22_NewAction.doc2Flg}"
								target="_blank"
								value="#{brandFinancialDetails_2021_22_NewAction.savefile}">
					...
					<div class="col-md-2" align="left">
						<rich:calendar
							value="#{brandFinancialDetails_2021_22_NewAction.uploaddate}"></rich:calendar>
					</div>
				...
				<div class="row" align="center">
					...
					<div class="col-md-12">
						...
						<h:commandButton styleClass="btn btn-primary"
							action="#{brandFinancialDetails_2021_22_NewAction.save}" value="Save" />
						<rich:spacer width="10px" />
						<h:commandButton
							action="#{brandFinancialDetails_2021_22_NewAction.reset}"
				...
				<div align="center">
					<rich:dataTable width="80%" var="list" id="table" rows="10"
						value="#{brandFinancialDetails_2021_22_NewAction.savelist}">
						...
						<rich:column>
							...
							<h:commandButton value="Update"
								...
								actionListener="#{brandFinancialDetails_2021_22_NewAction.update}"
								styleClass="btn btn-primary">
							</h:commandButton>
							<h:commandButton value="Print"
								 rendered="#{list.digital_sign_date eq null}"
								actionListener="#{brandFinancialDetails_2021_22_NewAction.print}"
								styleClass="btn btn-info">
							</h:commandButton>

							<h:outputLink
								rendered="#{list.print_flg ne 'NA' and list.digital_sign_date eq null}"
								value="/doc/ExciseUp/LabelRegistration_21_22/Applications/pdf//F-#{list.requestid}_BrandFinancialDetail_New.pdf"
								target="_blank">
							...
							<h:outputLink
								...
								<f:param name="updatetype" value="2"></f:param>


							</h:outputLink><h:outputLink rendered="#{list.digital_sign_date ne null}"
							...
							<h:commandButton value="ReOpen"
								 rendered="#{list.digital_sign_date ne null}"
								actionListener="#{brandFinancialDetails_2021_22_NewAction.reopen}"
