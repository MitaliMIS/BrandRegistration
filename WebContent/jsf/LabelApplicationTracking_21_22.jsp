			...
			<div  >
				...
				<div class="row"
					...
					<h2>
						...
						<h:outputText align="center" value="Label Application Tracking 2021-22"
							style="COLOR: #000040; FONT-WEIGHT: bold; FONT-SIZE: 35px;">
						</h:outputText>
					</h2>
					<h:inputHidden value="#{labelApplicationTracking_21_22Action.hidden}" />
				</div>
				...
				<div class="row" align="center">
					<div class="col-md-12">
						<rich:dataTable id="table22" rows="10" width="100%"
							value="#{labelApplicationTracking_21_22Action.appList}" var="list"
							...
							<rich:column>
								...
								<h:commandButton rendered="#{list.flag}"
									...
									actionListener="#{labelApplicationTracking_21_22Action.getApp_id}"
									action="#{labelApplicationTracking_21_22Action.replyMethod}" />
							</rich:column>
							...
							<rich:column >
								...
								<h:outputLink rendered="#{list.digitalSignPdf}" 
									value="/doc/ExciseUp/LabelRegistration_21_22/Applications/pdf//#{list.app_id}_ApprovedLicensing_esign.pdf"
									target="_blank">
				...
				<div class="row" align="center">
					<div class="col-md-12" style="overflow-x: scroll;">
						<rich:dataTable id="table2" width="100%"
							value="#{labelApplicationTracking_21_22Action.summaryList}" var="list"
							headerClass="TableHead" footerClass="TableHead"
							styleClass="DataTable" rowClasses="TableRow1,TableRow2">
				...
				<div class="row" align="center">
					<h:commandButton style="margin : 30px;" class="btn btn-danger"
						...
						action="#{labelApplicationTracking_21_22Action.back}" />
				</div>
