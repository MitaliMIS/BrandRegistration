...
hr.style-seven:before { /* Not really supposed to work, but does */
 ...
 <h:form>
				<div class="row " align="center">
					...
					<h:inputHidden value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.hidden}"></h:inputHidden>
				</div>
				...
				<a4j:outputPanel  id='msg23'>
											<h:outputLabel value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.err}" style="color: red"
											 rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.err_flag}">
					...
					<div align="center" class="pghead">
						<h:inputHidden
							value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.hidden}"></h:inputHidden>
						<h:outputLabel
							value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.user_Name}"
							style="COLOR: #000000; FONT-SIZE: x-large;"></h:outputLabel>
						<div align="center">
							<h:outputLabel
								value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.user_Address}"
				...
				<div class="row " align="center">
					...
					<h:panelGroup rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFlag==false}">
        ...
        <rich:dataTable width="90%" var="list" id="table1"  
					value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.brandList}">
					...
					<rich:column align="center">
						...
						<h:commandButton actionListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.view}" value="Select" disabled="#{list.int_pending_mrp==0}" styleClass="btn btn-success btn-sm" />
					</rich:column>
				...
				<h:panelGroup rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFlag}">
				 <div class="row">
...
<div class="row " align="center">
					<rich:spacer height="20px"></rich:spacer>
						...
						<div class="row col-md-12" align="center"
							...
							<h:selectOneRadio    rendered="false"
								value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unit_type}" 
						...
						<div class=" row col-md-12">
							...
							<h:outputText value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.brand_name}"></h:outputText>
						</div>
  ...
  <div class="row " align="center">
				...
				<h:panelGroup
								rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.yes_no eq 'YES'}">
								<div class="row " align="center">
									<rich:spacer height="20px"></rich:spacer>
								</div>
								<div class="row">
									<div class=" row col-md-2" align="right">
										...
										<h:outputLabel value="Select Unit Name"></h:outputLabel>

									</div>
									<div class=" row col-md-2" align="left" style="height: 24px;">
										<h:selectOneMenu
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.bwfl_unit_id}"
											styleClass="dropdown-menu1" disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.edp_flag}"
											valueChangeListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.bwfl_unit_idlistner}"
											onchange="this.form.submit();" style=" width : 371px;">
											<f:selectItems
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unit_namelist}" />
										</h:selectOneMenu>
									</div>
									...
									<div class=" row col-md-2" align="left">
										<h:selectOneMenu styleClass="dropdown-menu1"
											onchange="this.form.submit();" disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.edp_flag}"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.civil_brand_id}" style=" width : 367px;"
											valueChangeListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.civil_brand_idlistner}">

											<f:selectItems
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.civilbrandeListnew}" />
										</h:selectOneMenu>
									</div>
				...
				<div class="  col-md-6" align="right">
					...
					<div class="col-md-12">
						...
						<rich:dataTable columnClasses="columnClass1"
							...
							value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.calculation_750ml_list33}"
							var="list">
							...
							<rich:column width="7%"  >
								...
								<h:inputText value="#{list.profit }"  
								 valueChangeListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.edpChangebase_edp}"
...
<div class="row" align="left">
					...
					<div class="col-md-12">
						...
						<rich:dataTable columnClasses="columnClass1"
							...
							value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.state_list}"
							var="list">
							<rich:column width="4%">
								<f:facet name="header">
				...
				<h:commandButton action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.save}"
						value="Save" styleClass="btn btn-success btn-sm" />



					<rich:spacer width="20px;" />
				<h:commandButton styleClass="btn btn-warning btn-sm" action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.back}"  value="Back"></h:commandButton>
				</div>
				<div class="row " align="center">
					<rich:spacer height="20px"></rich:spacer>
				</div>
				...
				<div align="center">
					<rich:dataTable columnClasses="columnClass1"
						...
						width="80%" rows="10"
						value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.savelist}"
						var="list">
						...
						<rich:column>
							...
							<h:commandButton value="Upload Documents"
								actionListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.Upload_documents}"
               ...
               <h:outputLink rendered="#{list.digital_sign_date ne null}"
						...
						<rich:column>
							...
							<h:commandButton rendered="#{list.flag}"
								...
								actionListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.getApplication_no}"
								action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.replyMethod}" />
						</rich:column>
				...
				<h:panelGroup
					rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.upload_flg eq 'T' }">
					...
					<div class="row " align="center">
						<div
							...
							<div class="col-md-12" align="center">
								<h:outputText
									value=" Application No.:#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.showApplication_no}"
				...
				<div class="  col-md-6" align="right">
							...
							<div class="row">
										<rich:dataTable id="table3" rows="10" width="50%"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.showUploadeddocument}"
											...
											<rich:column  >
												<f:facet name="header">
													<h:outputText value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.text12}" 
													styleClass="preformatted">
													</h:outputText>
							...
							<h:panelGroup
								rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unitType eq 'IUCIVIL' or  application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unitType eq 'IUCSD'}">
								...
								<div class="col-md-12 btn " style="background-color: beige;">
									...
									<div class="col-md-2" align="left">
										<rich:fileUpload clearControlLabel="clear"
											...
											disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.check_upload_flg eq 'T' }"
											...
											fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader1}">
									...
									<div class="col-md-1 img-responsive" align="left">
										...
										<a4j:outputPanel id="renpdftrue1">
											<h:outputLink
												rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc1Flg}"
												target="_blank"
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile1}">
									...
									<div class="col-md-2" align="left">
										<rich:fileUpload clearControlLabel="clear"
											...
											acceptedTypes="pdf" clearAllControlLabel="Clear All"
											listWidth="220" listHeight="10" maxFilesQuantity="1"
											fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader2}">
											<a4j:support event="onuploadcomplete"
									...
									<div class="col-md-1 img-responsive" align="left">
										...
										<a4j:outputPanel id="renpdftrue2">
											<h:outputLink
												rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc2Flg}"
												target="_blank"
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile2}">
							...
							<div class="col-md-1"></div>
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader4}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue4">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc4Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile4}">
							...
							<h:panelGroup rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unitType eq 'IUCIVIL' or  application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.unitType eq 'IUCSD'}">
							<div class="col-md-12 btn " style="background-color: beige;">
								<div class="col-md-1"></div>
								<div class="col-md-2" align="right">
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader5}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue5">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc5Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile5}">
								...
								<div class="col-md-2" align="right">
									...
									<div class="col-md-2" align="left">
										<rich:fileUpload clearControlLabel="clear"
											...
											acceptedTypes="pdf" clearAllControlLabel="Clear All"
											listWidth="220" listHeight="10" maxFilesQuantity="1"
											fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader8}">
											<a4j:support event="onuploadcomplete"
									...
									<div class="col-md-1 img-responsive" align="left">
										...
										<a4j:outputPanel id="renpdftrue8">
											<h:outputLink
												rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc8Flg}"
												target="_blank"
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile8}">
								...
								<div class="col-md-12 btn " style="background-color: beige;">
									...
									<div class="col-md-2" align="left">
										<rich:fileUpload clearControlLabel="clear"
											...
											acceptedTypes="pdf" clearAllControlLabel="Clear All"
											listWidth="220" listHeight="10" maxFilesQuantity="1"
											fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader11}">
											<a4j:support event="onuploadcomplete"
									...
									<div class="col-md-1 img-responsive" align="left">
										...
										<a4j:outputPanel id="renpdftrue11">
											<h:outputLink
												rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc11Flg}"
												target="_blank"
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile11}">
									...
									<div class="col-md-2" align="left">
										<rich:fileUpload clearControlLabel="clear"
											...
											acceptedTypes="pdf" clearAllControlLabel="Clear All"
											listWidth="220" listHeight="10" maxFilesQuantity="1"
											fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader12}">
											<a4j:support event="onuploadcomplete"
									...
									<div class="col-md-1 img-responsive" align="left">
										...
										<a4j:outputPanel id="renpdftrue12">
											<h:outputLink
												rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc12Flg}"
												target="_blank"
												value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile12}">
							...
							<div class="col-md-12 btn " style="background-color: beige;">
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										stopControlLabel="Stop"
										disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc13Flg}"
										ontyperejected="if (!confirm('Only pdf allowed !')) return false"
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader13}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue13">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc13Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile13}">
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										stopControlLabel="Stop"
										disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc14Flg}"
										ontyperejected="if (!confirm('Only pdf allowed !')) return false"
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader14}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue14">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc14Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile14}">
							...
							<div class="col-md-12 btn " style="background-color: beige;">
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader9}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue9">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc9Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile9}">
								...
								<div class="col-md-2" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.uploader10}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-1 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue10">
										<h:outputLink
											rendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.doc10Flg}"
											target="_blank"
											value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.viewFile10}">
							...
							<div class="col-md-12" align="center">
								...
								<h:commandButton
									disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.check_upload_flg eq 'T' }"
									action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.finalize}"
								...
								<h:commandButton
									disabled="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.check_upload_flg eq 'T' }"
									action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.reset_uploading}"
									value="Reset" styleClass="btn btn-default btn-sm" />

								<rich:spacer width="20px;" />

								<h:commandButton
									action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.close_uploading}"
 ...
 <rich:modalPanel id="popup3" minWidth="1000" autosized="true"
			showWhenRendered="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.panle_flg}">
			<f:facet name="header">
			...
			<h:form>
				...
				<div class="col-md-12">
					...
					<div class="col-md-12">
						...
						<div class="col-md-3" align="left">
							<h:selectOneRadio
								value="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.yes_no}"
								valueChangeListener="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.yes_no_listner}"
								onchange="this.form.submit();">
				...
				<div class="col-md-12" align="center">
					...
					<a4j:commandButton value="Submit"
						...
						action="#{application_for_MRP_EDP_Approval_22_23_IMPORTED_IUCSDAction.close_poup}"
