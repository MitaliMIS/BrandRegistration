<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<f:view>
		<h:form>
			<div>
				<h:inputHidden value="#{labelUploading_22_23Action.hidden}" />
			</div>
			...
			<div class="row " align="center">
				<div align="center">
					...
					<div class="col-md-8" align="center">
						<b> <h:outputText value=" Upload Label And Other Documents 2022-23"
			...
			<h:panelGroup rendered="#{labelUploading_22_23Action.app_panel}">
				<div class="row" align="center">
					<rich:dataTable align="center" id="table3" width="90%"
						var="app_list" value="#{labelUploading_22_23Action.applicationlist}"
						...
						<rich:column align="center" width="50px">
							<f:facet name="header">
								<h:outputText value="Created Date" style="FONT-WEIGHT: bold;" />
							</f:facet>
						...
						<rich:column align="center" width="50px">
							<f:facet name="header">
								<h:outputText value="Liqour Type" style="FONT-WEIGHT: bold;" />
							</f:facet>
						...
						<rich:column align="center" width="50px">
							...
							<h:outputText value="#{app_list.lic____type}" />
						...
						<rich:column align="center" width="50px">
							...
							<h:commandButton value="View Brands"
								...
								actionListener="#{labelUploading_22_23Action.viewBrands}"
					...
					<div class="row" align="center">
						<h:commandButton styleClass="btn btn-danger"
							action="#{labelUploading_22_23Action.bck}" value="Back To Dashboard" />
			...
			<h:panelGroup rendered="#{labelUploading_22_23Action.brand_panel}">
					...
					<div class="col-sm-10">
						<div class="row">
							<div class="col-sm-4" align="left">
								...
								<h:outputText value="#{labelUploading_22_23Action.app_id }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Created Date :- "
									style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.app_date }" />
							</div>
							<div class="col-sm-4" align="left">
							...
							<div class="col-sm-4" align="left">
								<h:outputText value="Liqour Type:- "
									style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.lic_cat }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Liqour Category:- "
									style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.liquor_Category }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Sub Type:- "
									style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.sub_type }" />
							</div>
							...
							<div class="col-sm-4" align="left">
								<h:outputText value="License Type:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.lic___type }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Domain Name:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.domain_name }" />
							</div>
				...
				<div class="row" align="center">
					<rich:dataTable align="center" id="table2" width="90%"
						var="brand_list" value="#{labelUploading_22_23Action.brandlist}"
						headerClass="TableHead" footerClass="TableHead"
						rowClasses="TableRow1,TableRow2">
						<f:facet name="header">
						...
						<rich:column align="center" width="50px">
							...
							<h:commandButton value="Upload Labels And Other Documents"
								onclick="this.form.submit();"
								actionListener="#{labelUploading_22_23Action.viewLabels}"
								class="btn btn-primary" />
				...
				<div class="row" align="center">
					...
					<h:commandButton value="Back to Applications"
						onclick="this.form.submit();"
						actionListener="#{labelUploading_22_23Action.application_visible}"
						class="btn btn-success" />

				</div>
			</h:panelGroup>
			<h:panelGroup rendered="#{labelUploading_22_23Action.label_panel}">
				<div class="row" align="center" style="margin-bottom: 15px;">
					<div class="col-sm-1"></div>
					<div class="col-sm-10">
						<div class="row">
							...
							<div class="col-sm-4" align="left">
								<h:outputText value="Brand Name:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.brand_name }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Size:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.size }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="Package Type:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.package_type }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="No. of Label:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.noOfLabel }" />
							</div>
							<div class="col-sm-4" align="left">
								<h:outputText value="No. Of Years:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.yearforbrand }" />
							</div>

						</div>
					</div>
					<div class="col-sm-1" align="left">
						<h:outputText value="Trademark No.:- " style="FONT-WEIGHT: bold;" />
								<h:outputText value="#{labelUploading_22_23Action.trademark_no_new_renew }" />
					</div>
				...
				<div class="row" align="center">
					<rich:dataTable align="center" id="table1" width="90%" var="list"
						value="#{labelUploading_22_23Action.list}" headerClass="TableHead"
						...
						<rich:column align="center">
							...
							<h:inputTextarea value="#{list.description}"
								...
								disabled="#{labelUploading_22_23Action.finalize_flg }" />

						</rich:column>
						<rich:column align="center" width="270px" rendered="#{labelUploading_22_23Action.labelchange_flg_NEW eq 'YES' or labelUploading_22_23Action.labelchange_flg_NEW eq 'NA'}">
							<f:facet name="header">
							...
							<rich:fileUpload listHeight="10px" listWidth="230px"
								fileUploadListener="#{labelUploading_22_23Action.uploadImg}"
						...
						<rich:column align="center" width="50px" rendered="#{labelUploading_22_23Action.labelchange_flg_NEW eq 'YES' or labelUploading_22_23Action.labelchange_flg_NEW eq 'NA'}">
					...
					<div class="col-md-12" style="background-color: beige;">
							<div class="col-md-4" align="right">
								...
								<h:outputLink styleClass="outputLinkEx"
									rendered="#{labelUploading_22_23Action.renewalid==0}"
							...
							<div class="col-md-3" align="left">
								<rich:fileUpload clearControlLabel="clear"
									...
									fileUploadListener="#{labelUploading_22_23Action.uploadAffidavit}">
									<a4j:support event="onuploadcomplete"
							...
							<div class="col-md-5 img-responsive" align="left">
								...
								<a4j:outputPanel id="renpdftrue1">
									<h:outputLink rendered="#{labelUploading_22_23Action.doc1Flg}"
										target="_blank" value="#{labelUploading_22_23Action.saveAffidavit}">
								...
								<a4j:outputPanel id="renpdffalse1">
									<a4j:outputPanel rendered="#{!labelUploading_22_23Action.doc1Flg}">
										<h:graphicImage value="/img/nodoc.png"
											style="width : 60px; height : 35px;"></h:graphicImage>
						...
						<div class="col-md-12 btn " style="background-color: beige;">
								...
								<div class="col-md-3" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{labelUploading_22_23Action.uploadApprovedBR}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-5 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue2">
										<h:outputLink rendered="#{labelUploading_22_23Action.doc2Flg}"
											target="_blank"
											value="#{labelUploading_22_23Action.saveApprovedBR}">
									...
									<a4j:outputPanel id="renpdffalse2">
										<a4j:outputPanel rendered="#{!labelUploading_22_23Action.doc2Flg}">
											<h:graphicImage value="/img/nodoc.png"
												style="width : 60px; height : 35px;"></h:graphicImage>
							...
							<div class="col-md-12 btn " style="background-color: beige;">
								<div class="col-md-4" align="right">
									...
									<h:outputText style="  font-weight:bold"
										rendered="#{labelUploading_22_23Action.app_type eq 'N'}"
										value=" *Upload Certificate of Brand ownership :" />
									<h:outputText style="  font-weight:bold"
										rendered="#{labelUploading_22_23Action.app_type ne 'N' and labelUploading_22_23Action.app_type ne 'RNEW' and labelUploading_22_23Action.app_type ne 'LBC'  }"
										value=" *Upload 2021-22 Brand Approval Letter :" />
										<h:outputText style="  font-weight:bold"
										rendered="#{labelUploading_22_23Action.app_type eq 'RNEW' or labelUploading_22_23Action.app_type eq 'LBC'  }"
										value=" *Upload 2022-23 Brand Approval Letter :" />
								</div>
								<div class="col-md-3" align="left">
									<rich:fileUpload clearControlLabel="clear"
										stopControlLabel="Stop"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{labelUploading_22_23Action.uploadManualReciept}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-5 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue3">
										<h:outputLink rendered="#{labelUploading_22_23Action.doc3Flg}"
											target="_blank"
											value="#{labelUploading_22_23Action.saveManualReciept}">
									...
									<a4j:outputPanel id="renpdffalse3">
										<a4j:outputPanel rendered="#{!labelUploading_22_23Action.doc3Flg}">
											<h:graphicImage value="/img/nodoc.png"
												style="width : 60px; height : 35px;"></h:graphicImage>
							...
							<div class="col-md-12 btn " style="background-color: beige;">
								...
								<div class="col-md-3" align="left">
									<rich:fileUpload clearControlLabel="clear"
										...
										acceptedTypes="pdf" clearAllControlLabel="Clear All"
										listWidth="220" listHeight="10" maxFilesQuantity="1"
										fileUploadListener="#{labelUploading_22_23Action.uploadgsi}">
										<a4j:support event="onuploadcomplete"
								...
								<div class="col-md-5 img-responsive" align="left">
									...
									<a4j:outputPanel id="renpdftrue2123">
										<h:outputLink rendered="#{labelUploading_22_23Action.doc2Flggsi}"
											target="_blank"
											value="#{labelUploading_22_23Action.savegsi}">
									...
									<a4j:outputPanel id="renpdffalse2123">
										<a4j:outputPanel rendered="#{!labelUploading_22_23Action.doc2Flggsi}">
											<h:graphicImage value="/img/nodoc.png"
												style="width : 60px; height : 35px;"></h:graphicImage>
					...
					<div class="row" align="center">
						...
						<h:commandButton value="Save"
							action="#{labelUploading_22_23Action.save }"
							disabled="#{labelUploading_22_23Action.finalize_flg }"
							class="btn btn-primary" />
						<h:commandButton value="Finalize"
							action="#{labelUploading_22_23Action.finalize }"
							disabled="#{labelUploading_22_23Action.finalize_flg }"
					...
					<div class="row" align="center">
						...
						<h:commandButton value="Back to Brands"
							onclick="this.form.submit();"
							actionListener="#{labelUploading_22_23Action.brand_visible}"
