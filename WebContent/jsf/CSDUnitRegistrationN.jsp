...
<head>
    ...
    <h:form >
      <f:view >
       ...
       <div class="row" style=" width: 100%;" align="center" ><a target="_self" href="/portal/home" align="center"  >  
					
																					 <h:outputText  value="Back " align="center"  style="COLOR: #8005c1;  font-weight: bold;  font-size: 30px;text-decoration: underline; "/>
       ...
       <a4j:outputPanel id="All" > 
        <div class="row " align="center">
	        ...
	        <div class="col-md-2">
		          ...
		          styleClass="form-control">
											...
											<f:selectItem itemLabel="OutSide U.P. Distillery" itemValue="OUPD" />
											<f:selectItem itemLabel="OutSide U.P. Brewery" itemValue="OUPB" />
											<f:selectItem itemLabel="OutSide U.P. Winery" itemValue="OUPW" />
											<f:selectItem itemLabel="OutSide U.P. Bottling Unit" itemValue="OUPBU" />
        ...
        <div class="row " align="center">
         ...
         <div class="row " align="center">
       		...
       		<div class="col-md-2">
       			<h:selectOneMenu styleClass="form-control" value="#{cSDUnitRegistrationAction.districtIdWorkAdd}" onchange="this.form.submit();"  >
