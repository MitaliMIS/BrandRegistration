	...
	<f:view>
		<h:form style="background-color:whitesmoke;">
			...
			<div class="form-group">
				...
				<div class="row">
					<div align="center">
						<h:outputText value="EIN Generation 2022-23"
				...
				<div class="row" align="center">
					...
					<div class="row" align="center">
                  <h:outputText value=" ETIN Code ( #{eTIN_GenrationAction.etin_code} )" style="FONT-WEIGHT: bold; BACKGROUND-COLOR: #ffffff; COLOR: #ff0000; FONT-SIZE: x-large;"/>
                  </div>
